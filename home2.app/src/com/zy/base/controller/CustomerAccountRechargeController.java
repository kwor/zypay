...
public class CustomerAccountRechargeController {
	 ...
	 * 
	 * @ResponseBody public List< CustomerAccountRecharge > findAll(){ return
	 * customerAccountRechargeService.findAll(null); }
	 * 
	 * 
	 * //下面是数据库逻辑操作，不是实际接口，不开放，管理端备用 //创建记录
	 * 
	 * @RequestMapping(method = RequestMethod.POST)
	 * 
	 * @ResponseStatus(HttpStatus.CREATED)
	 * 
	 * @ResponseBody public int create(@RequestBody CustomerAccountRecharge
	 * resource) { Preconditions.checkNotNull(resource); // return
	 * customerAccountRechargeService.create(resource); }
	 * 
	 * //修改记录
	 * 
	 ...
	 * id,@RequestBody CustomerAccountRecharge resource) {
